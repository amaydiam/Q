...
public class History implements Parcelable {
    ...
    @SerializedName("washersName")
    @Expose
    private String washersName;
    ...
    public String getWashersName() {
        return washersName;
    }

    public void setWashersName(String washersName) {
        this.washersName = washersName;
    }
